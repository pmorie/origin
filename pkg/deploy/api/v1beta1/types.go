...
const (
	DeploymentTriggerTypeManual         DeploymentTriggerType = "Manual"
	DeploymentTriggerTypeOnImageChange  DeploymentTriggerType = "ImageChange"
	DeploymentTriggerTypeOnConfigChange DeploymentTriggerType = "ConfigChange"
)
